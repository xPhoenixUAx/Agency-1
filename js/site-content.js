...
(function () {
  ...
  pages: {
    ...
    cookies: {
      ...
      noticeTitle: "Only an essential form-session cookie is currently used.",
      ...
      sections: [
        ...
        { id: "current-cookie", title: "2. Cookie currently used", paragraphs: ["Ordinary page browsing does not require a first-party cookie. When you submit the enquiry form, the server starts a short-lived session used for abuse prevention and rate limiting."], bullets: [], table: { caption: "Current cookie inventory", headers: ["Cookie", "Provider", "Category", "Purpose", "Duration"], rows: [["PHPSESSID", "{{brand.name}} (first party)", "Strictly necessary", "Maintains the server session used to protect the enquiry form against repeated automated submissions.", "Browser session"]] } },
        ...
        { id: "manage", title: "5. Browser controls", paragraphs: ["You can inspect, block or delete cookies through your browser settings. Blocking the essential session cookie may prevent the enquiry form’s security and rate-limiting controls from working correctly, but it does not prevent access to ordinary website content."], bullets: [] },
